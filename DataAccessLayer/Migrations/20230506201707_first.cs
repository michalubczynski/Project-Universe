...
namespace DAL_DataAccessLayer.Migrations
{
    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Ships",
                columns: new[] { "Id", "IfBroken", "MaxSpeed", "ShipModel", "ShipName", "SingleChargeRange" },
                values: new object[,]
                {
                    { 1, false, 10, "m0001", "StarShip_1", 12 },
                    { 2, false, 100, "m0002", " StarShip_2", 120 },
                    { 3, true, 1000, "m0003", "StarShip_3", 122 }
                });
